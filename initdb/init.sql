...
('user1@example.com', 'user1', md5('password1'), '1990-01-15', 'default.jpg', 1),
('user2@example.com', 'user2', md5('password2'), '1985-05-22', 'default.jpg', 2),
('user3@example.com', 'user3', md5('password3'), '1998-09-10', 'default.jpg', 3);
